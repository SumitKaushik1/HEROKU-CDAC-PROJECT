...
public class DatabaseInitializerListener implements ServletContextListener {
    ...
    private void initializeDatabase() throws URISyntaxException, SQLException {
        ...
        try (Connection connection = DBUtils.getConnection();
            ...
            ResultSet rs = stmt.executeQuery("SHOW SCHEMAS LIKE '" + dbName + "'");
            if (!rs.next()) {
                // Schema does not exist, proceed with creation and initialization

                // Create schema
                stmt.execute("CREATE SCHEMA `" + dbName + "` DEFAULT CHARACTER SET utf8");
                ...
                // Insert sample data
                stmt.execute("INSERT INTO `users` (`user_id`, `user_first_name`, `user_last_name`, `user_password`, `user_mobile`, `user_address`) VALUES " +
                ...
                stmt.execute("INSERT INTO `roles` (`role_id`, `role_name`, `role_description`) VALUES " +
                ...
                stmt.execute("INSERT INTO `permission` (`per_id`, `per_module`, `per_name`, `Roles_role_id`) VALUES " +
                ...
                stmt.execute("INSERT INTO `schedule` (`sch_id`, `sch_type`, `sch_description`) VALUES " +
                ...
                // Schema exists, no need to recreate
